...
```
3. copy the bookmarklet text above and then make it into a bookmark by putting this into the url line of a bookmarklet
4. click on it on any site, make sure you have a google sheet tracker ready to input into trackerhub.
